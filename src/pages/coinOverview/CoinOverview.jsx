...
const CoinOverview = () => {
  ...
  return (
    <div className='md:p-10 sm:p-5 p-3'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='flex flex-col gap-4 text-justify'>
          ...
          <div className='text-darkGray font-xs' dangerouslySetInnerHTML={{ __html: sanitizedDescription }}></div>
        </div>
        <button className='flex justify-center items-center rounded-xl gap-2 bg-lightBlue py-4'>
